...
## ⚠️ Важно: как работают сессии
FamilyLog фиксирует сообщения в момент их отправки — независимо от того, как они выглядят в чате после. Telegram хранит историю всех событий, и бот получает их все при сборе, даже если вы что-то удалили или отредактировали.
